"""
Orienteering Problem Adapter for VL
...
Usage in other VL modules:
    Instead of:
        from orienteering.orienteering_traditional import OrienteeringProblem, OrienteeringState
    
    Use:
        from VL.orienteering_adapter import OrienteeringProblem, OrienteeringState, END_NODE, START_NODE
"""
...
def set_variant(use_no_end: bool):
    ...
    will not be affected. Call this BEFORE importing other VL modules.
