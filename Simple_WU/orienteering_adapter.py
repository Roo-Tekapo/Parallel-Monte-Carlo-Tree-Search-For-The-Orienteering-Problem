"""
Orienteering Problem Adapter for Simple_WU
...
Usage in other Simple_WU modules:
    Instead of:
        from orienteering.orienteering_traditional import OrienteeringProblem, OrienteeringState
    
    Use:
        from Simple_WU.orienteering_adapter import OrienteeringProblem, OrienteeringState, END_NODE, START_NODE
"""
...
_USE_NO_END = os.environ.get('SIMPLE_WU_USE_NO_END', 'false').lower() in ('true', '1', 'yes')
...
def set_variant(use_no_end: bool):
    ...
    will not be affected. Call this BEFORE importing other Simple_WU modules.
